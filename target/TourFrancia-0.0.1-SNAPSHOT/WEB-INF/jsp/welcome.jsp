...
<spring:url value="/resources/css/responsiveslides.css" var="responsiveSlidesCSS" />
<spring:url value="/resources/js/responsiveslides.min.js" var="responsiveSlidesJS" />
<script
...
<div class="header">
	 <div class="container">
		 <div class="logo">
			   <h1><a href="index.html">Le Tour de Francia</a></h1>
		 </div>	
		 <div class="top-menu">
...
<div class="strip">
	 ...
	 <div class="social">			 
			 ...
			 <a href="https://plus.google.com/+LeTourDeFrance"><i class="google"></i></a>	
			 <a href="https://www.youtube.com/user/letourdefrance"><i class="youtube"></i></a>	
	 </div>
		<div class="clearfix"></div>
		</div>
</div>
 ...
 <div class="slider">
	  <div class="callbacks_container">
	     <ul class="rslides" id="slider">
	         ...
	         <li>
	             <img src="/resources/images/bnr1.jpg" alt="">
	        	 <div class="banner-info">
				  <h3>Sed ultricies elementum.</h3>
				  <p>Lorem Interdum et malesuada fames ac ante ipsum primis in faucibus. Donec a odio quam. Aenean ipsum arcu, 
				  luctus vel ultricies ut, commodo sed turpis. Phasellus tristique lorem sit amet tellus dignissim hendrerit.
